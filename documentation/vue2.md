...
![TwicPics Components](https://raw.githubusercontent.com/twicpics/components/0.6.6/documentation/resources/vuejs-cover.png)
...
Thanks to the open source [TwicPics](https://www.twicpics.com/?utm_source=github&utm_medium=organic&utm_campaign=components) Components, delivering responsive images in your [Vue2](https://vuejs.org/index.html) projects has never been easier.
...
| `debug` | When set to `true`, all src attributes will target a [placeholder:auto](https://www.twicpics.com/docs/api/placeholders). | `Boolean` | false |
